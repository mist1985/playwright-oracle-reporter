...
export const LEGACY_ENV_VARS = {
  OPENAI_API_KEY: "OPENAI_API_KEY",
  OUTPUT_DIR: "PW_AI_OUTPUT_DIR",
  HISTORY_DIR: "PW_AI_HISTORY_DIR",
  OPEN_REPORT: "PW_AI_OPEN_REPORT",
  RUN_LABEL: "PW_AI_RUN_LABEL",
  TELEMETRY_INTERVAL: "PW_AI_TELEMETRY_INTERVAL",
  AI_MODE: "PW_AI_AI_MODE",
  OPENAI_MODEL: "PW_AI_OPENAI_MODEL",
  OPENAI_MAX_TOKENS: "PW_AI_OPENAI_MAX_TOKENS",
  OPENAI_TIMEOUT_MS: "PW_AI_OPENAI_TIMEOUT_MS",
  OPENAI_RETRIES: "PW_AI_OPENAI_RETRIES",
  OPENAI_ENABLED: "PW_AI_OPENAI_ENABLED",
  LOG_LEVEL: "PW_AI_LOG_LEVEL",
  SILENT: "PW_AI_SILENT",
  THRESHOLD_LOAD1: "PW_AI_THRESHOLD_LOAD1",
  THRESHOLD_PRESSURE: "PW_AI_THRESHOLD_PRESSURE",
  THRESHOLD_IOWAIT: "PW_AI_THRESHOLD_IOWAIT",
  THRESHOLD_STEAL: "PW_AI_THRESHOLD_STEAL",
  OPENAI_MAX_INPUT_CHARS: "PW_AI_OPENAI_MAX_INPUT_CHARS",
} as const;

type EnvVarKey = keyof typeof ENV_VARS;

export function getEnvVar(key: EnvVarKey): string | undefined {
  return process.env[ENV_VARS[key]] ?? process.env[LEGACY_ENV_VARS[key]];
}
